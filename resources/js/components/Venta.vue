        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" @click="monstrarDetalle()" class="btn btn-secondary">
                            ...
                            <div class="form-group row border">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" v-model="serie_comprobante" placeholder="000x">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Número Comprobante (*)</label>
                                        <input type="number" class="form-control" v-model="num_comprobante" placeholder="00xx">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="table-responsive col-md-12">
                                        ...
                                        <tbody v-if="arrayDetalle.length">
                                            <tr v-for="(detalle, index) in arrayDetalle" :key="detalle.id">
                                                ...
                                                <td>
                                                    <input v-model="detalle.precio" type="number" value="0" id="form-control">
                                                </td>
                                                <td>
                                        ...
                                        <tbody v-else>
                                            <tr><td class="text-center" colspan="6">No hay artículos agregados</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="form-group row border">
                                <div class="table-responsive col-md-12">
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody v-else>
                                            <tr><td class="text-center" colspan="4">No hay artículos agregados</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods : {
            ...
            agregarDetalle(){
                ...
                if(me.idarticulo == 0 || me.cantidad == 0 || me.precio == 0){}
                    ...
                    if(me.encuentra(me.idarticulo)){
                        ...
                        Toast.fire({
                            icon: 'error',
                            title: '¡El artículo ya se encuentra agregado!'
                        })
            ...
            validarVenta(){
                ...
                if(!me.num_comprobante) me.errorMostrarMsjVenta.push('Ingrese el número del comprobante');
                if(!me.impuesto) me.errorMostrarMsjVenta.push('Ingrese el impuesto de compra');
                if(me.arrayDetalle.length <= 0) me.errorMostrarMsjVenta.push('Ingrese algún producto a la lista');
            ...
            desactivarIngreso(id){
                ...
                if (result.value) {
                    ...
                    axios.put('/ingreso/desactivar',{
                        ...
                        Toast.fire({
                            icon: 'success',
                            title: 'El ingreso ha sido anulado'
                        })
                    }).catch(function (error) {
                        console.log(error);
                    });
