                        ...
                        <form method="POST">
                            ...
                            <div class="form-group row border">
                                <div class="table-responsive col-md-12">
                                        ...
                                        <tbody v-else>
                                            <tr><td class="text-center" colspan="5">No hay artículos agregados</td></tr>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
    ...
    export default {
        ...
        methods : {
            ...
            validarIngreso(){
                ...
                if(this.arrayDetalle.length <= 0) this.errorMostrarMsjIngreso.push('Ingrese algún producto a la lista');
