                    ...
                    <div class="modal-body">
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" v-model="nombre" class="form-control" placeholder="Nombres de la persona">   
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if(!this.nombre) this.errorMostrarMsjPersona.push('¡Los nombres de la persona no puede estar vacío!');
